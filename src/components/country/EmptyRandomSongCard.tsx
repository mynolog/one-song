...
export default function EmptyRandomSongCard() {
  return (
    <div className="flex h-[450px] w-[50vw] flex-col gap-4 sm:w-75">
      <div className="relative -z-50 flex aspect-square w-full max-w-75 items-center justify-center rounded-md bg-[#f1f3f4]">
